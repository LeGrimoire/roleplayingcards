...
export function card_data_example() {
    ...
    var power = new PowerCard();
    power.title = "Power";
    power.contents = [
    ];
    cards.push(power);

    var goblin = new CreatureCard();
    goblin.title = "Goblin";
    ...
    var cunningAction = new PowerCard();
